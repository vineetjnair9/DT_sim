	...
	VSD::ModelNode(
		...
		(childNodes = [
			...
			VSD3D::CameraNode(
				...
				(relFrameTransform = 
					VSD3D::FrameTransform(
						(relFrame = "(0.99603402043027578,-0.080997650283308617,-0.036818180309780013,0.34901683471522116,0.088189089506469684,0.95357334115307801,0.28795931486245979,-3.0627046127189947,0.01178480807786679,-0.29006425257012497,0.95693459413813198,1.158588780972396,0,0,0,1)")
					)
				)
				(viewPointFixed = "0")
				(refPointFixed = "0")
